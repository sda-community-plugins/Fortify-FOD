...
import com.serena.air.plugin.fod.controllers.*
import okhttp3.*
...
class FodApi {
    ...
    StaticScanController getStaticScanController() { return staticScanController; }
    private ReleaseController releaseController;
    ReleaseController getReleaseController() { return releaseController; }
    private DynamicScanController dynamicScanController;
    DynamicScanController getDynamicScanController() { return dynamicScanController; }
    private ScanSummaryController scanSummaryController;
    ScanSummaryController getScanSummaryController() {  return scanSummaryController;  }
    ...
    public FodApi(String url, Proxy clProxy, String portalUri) {
        ...
        dynamicScanController = new DynamicScanController(this);
    ...
    private OkHttpClient Create(Proxy clProxy) {
        ...
        OkHttpClient.Builder builder = baseClient
                .proxy(new Proxy(Proxy.Type.HTTP, new InetSocketAddress(clProxy.getProxyUri().getHost(), clProxy.getProxyUri().getPort())));
