...
public class FodEnums {
    ...
    public final static String fodScanTool = "Deployment Automation";
    public final static String fodScanToolVersion ="6.3.2";
    public final static String fodScanMethodType = "CICD";
    ...
    public enum ScanType {
        ...
        public static ScanType fromInt(int val) {
            switch (val) {
